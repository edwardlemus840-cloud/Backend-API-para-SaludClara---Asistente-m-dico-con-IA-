...
app.listen(PORT, () => {
    ...
    console.log(`   - POST http://localhost:${PORT}/api/traducir`);
    console.log(`   - POST http://localhost:${PORT}/api/analizar-texto-medico (OCR + Groq)`);
    console.log(`   - POST http://localhost:${PORT}/api/analizar-documento (OpenAI Vision)`);
    ...
    if (!groqConfigured && !openaiConfigured) {
        console.log('⚠️  ADVERTENCIA: No hay APIs configuradas. Por favor configura GROQ_API_KEY o OPENAI_API_KEY en .env');
    }
});